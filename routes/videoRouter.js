...
/**
 * GET /api/videos/plan
 * Optional: ?sectionType=category&sectionValue=Top%20News&mode=scroll
 * - Mirrors /api/cartoons/plan behavior
 */
router.get('/plan', async (req, res) => {
  try {
    ...
    const sections = await VideoSection.find(q).sort({ sortIndex: 1, createdAt: -1 }).lean();
